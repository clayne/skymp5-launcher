...
namespace UpdatesClient.Modules.GameManager.Helpers
{
    ...
    {
        private static string[] DirectoriesSKSE = new string[] { "src", "Data\\Scripts" };
        private static string[] FilesSKSE = new string[] { "skse64_1_5_97.dll", "skse64_loader.exe", "skse64_readme.txt",
            "skse64_steam_loader.dll", "skse64_whatsnew.txt" };

        private static string[] Directories = new string[] { "tmp", "Data\\Interface", "Data\\meshes", "Data\\Platform",
            "Data\\ShaderCache", "Data\\SKSE", "Data\\textures" };
        private static string[] Files = new string[] { "README.txt", "version.json", "Data\\FarmSystem.esp" };
